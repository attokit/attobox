...
class WxPayApi
{
	...
	{		
		...
		curl_setopt($ch,CURLOPT_SSL_VERIFYPEER,FALSE);	//****后修改****  为了禁止 cURL 验证对等证书（peer's certificate）
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERT, WxPayConfig::ssl_cert_path());
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			//curl_setopt($ch,CURLOPT_SSLKEY, WxPayConfig::SSLKEY_PATH);
			curl_setopt($ch,CURLOPT_SSLKEY, WxPayConfig::ssl_key_path());
		}
		//post提交方式
